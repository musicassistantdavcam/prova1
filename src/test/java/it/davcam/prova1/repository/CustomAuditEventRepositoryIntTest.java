package it.davcam.prova1.repository;

import it.davcam.prova1.Prova1App;
import it.davcam.prova1.config.Constants;
import it.davcam.prova1.config.audit.AuditEventConverter;
import it.davcam.prova1.domain.PersistentAuditEvent;
...
import static it.davcam.prova1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
